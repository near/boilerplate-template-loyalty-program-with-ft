      ...
      {!!customerBalance || (
        <>
          <p className="mt-6 text-gray-600">
            Welcome to the customer app! It's your first time using this loyalty program, you don't have an account yet.
          </p>
          ...
          <p className="mt-2 text-gray-600">
            ...
            <br />
            - it will be a subaccount of the manager contract - see the contracts/manager-contract to see how this
            happens under the hood
            <br />
            - This account will be a full Near account. You can perform operations on the blockchain like getting and
            spending your tokens, deploying contracts and more.
            <br />
          </p>
        </>
      )}
